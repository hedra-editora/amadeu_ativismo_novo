...
\usepackage{caption}
\DeclareCaptionFont{formular}{\formular}
\captionsetup{labelformat=empty, font={footnotesize,formular}}
...
\newfontfamily\swift{SwiftNeueLTPro}
\setmainfont[Ligatures=TeX,Numbers=OldStyle]{MinionPro}
