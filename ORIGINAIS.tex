...
conhecido como \textsc{dd}o\textsc{s} (Distributed Denial of Service, em inglês), assim
...
\chapterspecial{O que as lideranças políticas brasileiras pensam sobre as redes
tecnossociais}{}{}
...
\chapterspecial{Participação cidadã e o uso das Tecnologias de Informação e Comunicação pela \textsc{abong}}{}{}

\begin{flushright}
\textsc{claudio luis de camargo penteado}\\
...
\textless{}http://portal.anpocs.org/portal/index.php?option=com\_doc % QUEBRADO
...
\chapterspecial{O Ocupa Sampa, os Indignados de São Paulo}{Usos e limites
...
\chapterspecial{Tecnologias de modulação e formatação da opinião em rede}{}{}

\begin{flushright}
\textsc{débora machado}\\
\textsc{joyce souza}\\
\textsc{sergio amadeu da silveira}
\end{flushright}
...
\begin{flushright}
\textsc{pollyana ferrari teixeira}\\
