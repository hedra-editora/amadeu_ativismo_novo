...
de governo eletrônico, \textit{e"-participação}, deliberação \emph{online} e, mais
...
\emph{Ciberpolítica: política e internet} temos trabalho
...
Joyce Miranda Leão Martins, da \textsc{puc--sp}, tem base em resultados de
...
Na segunda seção, \emph{Ciberativismo: Participação, Mobilização e
...
analistas (veja \textsc{landtscherr} et. al., 1999; \textsc{gibson} \& \textsc{ward}, 2000; \textsc{gibson},
...
informação, interação, mobilização e sofisticação (veja \textsc{silva}, 2013: p.
...
examinaremos ao todo 29 partidos políticos.
...
% incluídos na tabela a seguinte.
...
Internet (abril de 2017)\bigskip
...
{\footnotesize\emph{Fonte: Câmara dos Deputados Brasileira \& Congreso Nacional Espanhol.}}
\end{center}
\end{comment}


Como pode se constatar, qualquer que seja o estado da arte
...
\subsection{Informação e mobilização nos websites\break dos
partidos brasileiros e espanhóis}

Podemos agora passar à análise da presença \emph{online} dos partidos dos dois
...
% \begin{center}
% \textls[-5]{Gráfico 1: Estratégias de comunicação \emph{online} dos partidos brasileiros e
...
\paragraph{\textsc{gráfico 1}\quad Estratégias de comunicação \emph{online} dos partidos brasileiros e espanhóis em período não eleitoral (abril de 2017)} Pelo gráfico, podemos examinar as diferentes características dos \textsc{wp}s dos
...
seguintes: para os 25 partidos brasileiros, na variável ``ideologia'', o índice de informação é 0,568; o índice de interação é 0,196; o índice de mobilização é 0,548; o índice de sofisticação é 0,318; o \textsc{iwp} é 0,577. 
Na variável ``Tamanho da bancada em 2017'', os índices, na mesma ordem apresentada acima, são: 0,389; 0,290; -0,012; 0,59; e 0,387.
Para a variável ``Número de filiados'', temos: 0,394; 0,122; -0,174; 0,403; e 0,204.
Por fim, para a variável ``Capilaridade'', em porcentagem de governo local, os índices são:
0,389; 0,210; -0,114; 0,520; e 0,297.

Para os quatro partidos espanhóis, na variável ``Ideologia'' temos: índice de informação de 0,927; índice de interação de 0,892; índice de mobilização de 0,284; índice de sofisticação de 0,832; e \textsc{iwp} de 0,857. 
Na variável ``Tamanho da bancada em 2017'', os índices, na mesma ordem apresentada acima, são: -0,303; -0,375; -0,539; -0,317; e -0,454
Para a variável ``Número de filiados'', temos: -0,294; -0,373; -0,053; 0,006; e -0,226.
Por fim, para a variável ``Capilaridade'', em porcentagem de governo local, os índices são:
-0,358; -0,414; -0,772; -0,538; e -0,607.
...
{\footnotesize\emph{Fonte: Elaboração própria.}}
\end{center}
\end{comment}

Essa correlação de Pearson acima nos fornece várias informações
...
\paragraph{\textsc{gráfico 2}\quad Relação entre tamanho e \textsc{iwp} (partidos parlamentares brasileiros e espanhóis}
...
% \begin{center}
% Gráfico 3: Relação entre ideologia e índice de mobilização 
% %(partidos espanhóis e brasileiros)
% \end{center}
...
\paragraph{\textsc{gráfico 3}\quad Relação entre ideologia e índice de mobilização}
...
\subsection{Atenção e engajamento em rede}
...
Ao cruzar as características dos partidos e os indicadores de presença nas mídias digitais, chegamos aos seguintes dados: nos 25 partidos brasileiros, na variável ``Ideologia'', o índice de presença no Facebook é de 0,358; o índice de Seguidores no Twitter é de 0,341; o índice de Visualizações no YouTube é de 0,177; o índice de atenção nas redes é de 0,307.
Para a variável ``Tamanho da bancada em 2017'', os índices, na mesma ordem apresentada acima, são: 0,567; 0,621; 0,263; e 0,482.
Pra a variável ``Número de filiados'', os índices são: 0,412; 0,552; 0,227; e 0,372.
Para a variável ``Capilaridade'', em relação à porcentagem de governo local, os índices são: 0,497; 0,550; 0,252; e 0,433.

Para os quatro partidos espanhóis, , na variável ``Ideologia'', o índice de presença no Facebook é de 0,755; o índice de Seguidores no Twitter é de 0,822; o índice de Visualizações no YouTube é de 0,159; o índice de atenção nas redes é de 0,432.
Para a variável ``Tamanho da bancada em 2017'', os índices, na mesma ordem apresentada acima, são: -0,328; 0,026; -0,872; e -0,701.
Pra a variável ``Número de filiados'', os índices são: 0,048; 0,363; -0,515; e -0,298.
Para a variável ``Capilaridade'', em relação à porcentagem de governo local, os índices são: -0,570; -0,245; -0,980; e -0,882.
...
indicadores de presença nas midias sociais\bigskip
...
\paragraph{\textsc{gráfico 4}\quad Tamanho \textit{versus} grau de atenção nas mídias dos partidos brasileiros
e espanhóis}
...
Ao cruzar as características dos partidos e engajamento no Facebook --- entre 1º de janeiro de 2014 e 30 de abril de 2017 ---, chegamos aos seguintes dados: nos 20 partidos brasileiros, na variável ``Número de filiados'', em 2015, o índice de Postagens é de 0,335; o índice de Curtidas é de 0,339; o índice de Comentários é de 0,222; o índice de Compartilhamentos é de 0,300; o nível de Engajamento é de 0,335.
Para a variável ``Tamanho da bancada em 2015'', os índices, na mesma ordem apresentada acima, são: 0,589; 0,577; 0,568; 0,587; e 0,589.
Pra a variável ``Ideologia'', os índices são: 0,446; 0,436; 0,479; 0,461; e 0,446.
Para a variável ``Capilaridade'', em relação ao número de prefeituras, os índices são: 0,482; 0,439; 0,473; 0,481; e 0,482.

Para os quatro partidos espanhóis, na variável ``Número de filiados'', em 2015, o índice de Postagens é de 0,745; o índice de Curtidas é de 0,765; o índice de Comentários é de 0,769; o índice de Compartilhamentos é de 0,760; o nível de Engajamento é de 0,745.
Para a variável ``Tamanho da bancada em 2015'', os índices, na mesma ordem apresentada acima, são: -0,316; -0,248; -0,290; e -0,305; e -0,316.
Pra a variável ``Ideologia'', os índices são: 0,068; 0,131; 0,066; 0,72; e 0,068.
Para a variável ``Capilaridade'', em relação ao número de prefeituras, os índices são: -0,563; -0,504; -0,529; -0,551; e -0,563.

\begin{comment}
\begin{center}
Tabela 4: Matriz de correlação entre características dos partidos x
engajamento no Facebook (01/01/2014 a 30/04/2017)\bigskip
...
\paragraph{\textsc{gráfico 5}\quad Tamanho x engajamento dos partidos brasileiros e espanhóis no Facebook, de janeiro de 201 a abril de 2016}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=.5\textwidth]{./imgs/graf6_1.png}%
%
\includegraphics[width=.5\textwidth]{./imgs/graf6_2.png}%
\end{figure}

\begin{figure}[!htpb]
\centering
 \includegraphics[width=.5\textwidth]{./imgs/graf6_3.png}%
%
\includegraphics[width=.5\textwidth]{./imgs/graf6_4.png}%
\caption{Fonte: Elaboração dos autores.}
\end{figure}
\end{center}
\end{comment}
...
%Abaixo, ilustramos as postagens que provocaram maior
...
\tit{fuentes}, Josué Gonzáles. (2012), Web 2.0: visão geral sobre a
...
\tit{margolis}, M. \& \textsc{resnick}, D. (2000), \emph{Politics as Usual?} The
...
\tit{silva}, Catarina. (2012), A comunicação partidária \emph{\emph{online}}: Os websites
...
\tit{zittel}, Thomas. (2009), \emph{Lost in Technology?} Political Parties and
...
Em relação aos deputados federais da 54ª legislatura, constatamos um número médio de 4153 tweets, 7517 seguidores e 1079 pessoas que seguem.
Para os deputados da 55ª legislatura, os números foram maiores: 5588 tweets, 11364 seguidores e 1257 pessoas que seguem.
...
Partidos de Direita: \textsc{ptb, pr, dem, pp, ptn, psd, pen, psc, pros} e \textsc{pmb}.
Partidos de Centro: \textsc{pmdb, psdb, pps}, \textsc{pt}do\textsc{b}, \textsc{pv, phs,
psl, prb}, Solidariedade e Rede.
Partidos de Esquerda: \textsc{pc}do\textsc{b}, \textsc{pdt, psb, psol} e \textsc{pt}
(\textsc{melo}, 2011).
...
\begin{center}
\textls[-5]{Tabela 3: Ideologia dos deputados federais por número de tweets,
apresentada por quartis de volume de tweets: 54ª legislatura e 55ª
legislatura da Câmara dos Deputados do Brasil}\bigskip
...
Câmara dos Deputados do Brasil\bigskip
...
\tit{cardon}, Dominique (2012) \emph{A democracia Internet}: promessas e
...
\tit{chadwick}, Andrew. (2006) \emph{Internet politics}: \emph{states,
...
\tit{dagnino}, Evelina, \textsc{olvera}, Alberto, e \textsc{panfichi}, Aldo (orgs.) (2006\emph{)
...
\tit{hindman}, Matthew (2008) \emph{The Myth of Digital Democracy}. Princeton,
...
\tit{jensen}, Michael J.; \textsc{venkatesh}, Alladi. (2007)'' Government websites and
...
\tit{kies}, Raphäel. (2010) \emph{Promises and limits of web"-deliberation}.
Palgrave: Macmillan.
...
\tit{levitsky}, S. \textsc{ziblatt}, D. (2018) \emph{Como as democracias morrem}. Rio
de Janeiro: Zahar.

\tit{liff}, Sonia; \textsc{sheperd}, Adrian. (2004) \emph{An evolving gender digital
...
\tit{margolis}, Michael; \textsc{resnick}, David. (2000) \emph{Politics as usual}:
...
\tit{norris}, Pippa. (2001) \emph{Digital divide}: \emph{civic engagement,
information poverty \& and the Internet worldwide}. Cambridge: Cambridge
University Press.

\tit{panagopoulos}, Costas. (2009) \emph{Politicking online -- the
...
\tit{runciman}, D (2018) \emph{Como a democracia chega ao fim}. São Paulo:
Todavia.

\tit{trechsel}, Alexander H. et al. (2003) \emph{Evaluation of the use of new
...
\begin{bibliohedra}
\tit{aldé}, A.; \textsc{borges}, J. \emph{Internet, imprensa e as eleições de 2002}:
pautando notícia sem tempo real. Logos, Rio de Janeiro, n. 21. 2004.

\tit{alonso}, Angela. \emph{A Política Das Ruas}: Protestos em São Paulo de
Dilma a Temer. Novos Estudos. \textsc{cebrap}. São Paulo, ed. Especial, Jun/2017,
p.\,49--58.

\tit{castells}, Manuel. \emph{O poder da comunicação}. São Paulo: Paz e
Terra, 2015.

\tit{chicarino}, T.S.; \textsc{segurado}, R. \emph{Um candidato customizado}: as
...
\tit{bourdieu}, Pierre. \emph{O poder simbólico}. Rio de Janeiro: Bertrand
Brasil, 1989.

\tit{farrell}, David M; \textsc{web}, Paul. \emph{Political Parties as Campaing
...
\tit{gramsci}, Antonio. \emph{Maquiavel}. A política e o Estado Moderno. Rio
de Janeiro: Civilização Brasileira, 1968.

\tit{lobo}, Denis Carneiro. \emph{Coletivos organizados para mudar o perfil
...
\tit{massuchin}, Michele Goulart; \textsc{silva}, Luana Fonseca. \emph{Campanha
...
\tit{penteado}, Claudio. \emph{Marketing político na era digital}:
perspectivas e possibilidades. Revista \textsc{usp}, 2011, 90: 6--23.

\tit{pomian}, Krzysztof. \emph{A História das Estruturas}. In: \textsc{le} \textsc{goff},
...
\tit{sampaio}, Thiago. \emph{A mídia e a campanha permanente}: a disputa
...
\tit{solano}, Esther. \emph{Crise da Democracia e extremismos de direita}.
...
\tit{stromer}-\textsc{galley}, Jennifer. \emph{Presidential campaigning in the
Internet age}. Oxford University Press, 2014.

\tit{thompson}, John B. \emph{A mídia e a modernidade}. Uma teoria social da
...
Em outro estudo (\textsc{penteado} \emph{et al}, 2014) sobre o uso das \textsc{tic}s por
...
Em sua \emph{``Carta de Princípios''}, a \textsc{abong} evidencia que as
...
Assim, a \textsc{abong} em suas práticas desenvolve: (1) articulação entre
...
{\footnotesize\emph{Tabela elaborada pelos autores, 2019.}}
\end{center}
\end{comment}
...
anual da \textsc{\textsc{anpocs}}. Caxambu, 2012. Disponível em:
...
\tit{nogueira}, Marco Aurélio. \emph{Um Estado para a sociedade civil: temas
...
relação ao ano de 2010. %\footnote{Disponível em:
...
Como já apontou Carles Feixa (\textsc{feixa}, 2013: 53), ``em el princípio fue la
...
\footnote{Ver Conferência de David Harvey, Teatro da \textsc{puc--sp}, em 27 de
  fevereiro de 2012.} %:\emph{http://www.youtube.com/watchv=qMRsV7XWKqU\&feature=context\&context=C3a3057cUDOEgsToPDskJudIVHgGzwumBLufakKpZj} %QUEBRADO   Acessado em 25 de setembro de 2012.}.
\end{quote}
...
A aposta na comunicação \emph{online} impediu, segundo parte dos
...
\tit{castells}, Manuel. \emph{Redes de comunicação e esperança: movimentos
...
\tit{lemos}, Andre (org). \emph{Cibercidades: as cidades na cibercultura.} Rio
de Janeiro: E"-Papers, 2004.

\titidem; \textsc{levy}, Pierre.~\emph{O futuro da Internet}. São Paulo:
Paulus, 2010.

\tit{lipovetsky}, Gilles e \textsc{serroy}, Jean (2011). \emph{A cultura"-mundo:
resposta a uma sociedade desorientada}. São Paulo, Cia das Letras, 2011

\tit{maricato}, Ermínia {[}et al.{]}. \emph{Cidades rebeldes: Passe Livre e as
...
\tit{movimento passe livre} (et al.). \emph{Cidade rebeldes: Passe Livre e as
manifestações que tomaram as ruas do Brasil}. São Paulo, Boitempo, 2013.

\tit{recuero}, Raquel.~\emph{Redes sociais na Internet.~}Porto Alegre: Sulina,
2009.

\tit{reguillo}, Rossana. \emph{Culturas juveniles: formas políticas del
...
\tit{rosenmann}, Marcos Roitman. \emph{Los indignados: el rescate de la
política}. Madrid/España: Ediciones Akal, 2012.

\tit{williams}, Raymond (1992) \emph{Cultura}. Rio de Janeiro: Paz e Terra,
1992.
\end{bibliohedra}


\chapterspecial{Multidão ciborgue e império patriarcal}{}{}
...
\tit{haraway}, Donna (2009). Manifesto Ciborgue. Disponível em:
\emph{https://hedra.com.br/r/K2S}\textgreater{} %QUEBRADO
...
\tit{preciado}, Paul (2003); Multitudes~\emph{queer}. Notes for a politics of
...
Um exemplo pode ser encontrado na patente \textsc{us10002168b2}, \emph{Suggesting
search results to users before receiving any search query from the
...
\begin{bibliohedra}
\tit{bucher}, T. \emph{If\ldots{}Then: Algorithmic Power and Politics}. Oxford:
...
\tit{gershony}, O. \emph{et al.} \emph{Automatic suggestions and other
...
\tit{johnson}, M. D.; \textsc{patterson}, R. \emph{Suggesting search results to users
before receiving any search query from the users}. Disponível em:
\textless{}https://bit.ly/2MPrNBH\textgreater{}.
Acesso em: 21 set. 2018.

\tit{lasswell}, Harold D.. The Theory of Political Propaganda. \emph{The
American Political Science Review}, Vol. 21, No. 3 (Aug., 1927), pp.
627--631.

\tit{latour}, Bruno. \emph{Reagregando o social: uma introdução à teoria do
ator"-rede}. Edusc, 2012.

\tit{law}, John. Actor network theory and material semiotics. In: \emph{The
new Blackwell companion to social theory} / Edited Bryan S. Turner. p.
141--158, 2009.

\tit{nowak}, M.; \textsc{eckles}, D. \emph{Determining user personality
characteristics from social networking system communications and
...
\tit{o'neil}, C. \emph{Weapons of Math Destruction: How Big Data Increases
...
\tit{rubinstein}, Y. D. \emph{et al.} \emph{Instantaneous recommendation of
...
\tit{statista}. Google: ad revenue 2001--2017. \emph{Statista}, {[}S.l.{]},
...
\tit{the guardian}. \emph{The Cambridge Analytica Files}. 2018. Disponível
...
\tit{yu}, Y.; \textsc{wang}, M. \emph{Presenting additional content items to a social
networking system user based on receiving an indication of boredom}.
Disponível em:
...
\tit{bauman}, Zygmunt. \emph{Retropia}. Rio de Janeiro: Zahar, 2019.

\tit{castells}, Manuel. \emph{A Sociedade em Rede}. Volume I. 8ª edição
...
\tit{ferrari}, Pollyana (Org.). \emph{Fluido, fluxo}. Porto Alegre: Fi, 2018.
...
\tit{gama}, R.; \textsc{vilicic}, F.; \textsc{marthe}, M. Um basta à ignorância. \emph{Veja},
São Paulo, ed. 2652, ano 52, n. 38, 18 set. 2019.

\tit{geli}, Carles. \emph{Byung"-Chul Han: ``Hoje o indivíduo se explora e
...
\tit{guattari}, F.; \textsc{rolnik}, S. \emph{Micropolítica: cartografias do desejo.}
Rio de Janeiro: Vozes, 1986.

\tit{han}, Byung"-Chul. \emph{Topologia da violência}. Rio de Janeiro: Vozes,
2017.
...
\tit{susskind}, Jamie. \emph{Future Politics}. Nova Iorque: Oxford University
Press, 2018.
\end{bibliohedra}

\chapterspecial{Ciberpolítica, ciberativismo e cibercultura}{Uma análise dos
\emph{papers} apresentados no grupo de trabalho da \textsc{\textsc{anpocs}}\footnote{Uma
...
cibercultura'' na \textsc{\textsc{anpocs}} (criado em 2010 e mantido de forma ininterrupta
...
iniciativas de interação entre Estado e cidadãos.\footnote{Conforme a
  ...
  eletrônicos etc.)'' (\textsc{gomes}, 2007, p.\,11).}
...
distribuição longitudinal.
 ...
 \begin{center}
Distribuição de homens e mulheres ao longo dos anos no \textsc{gt}
 \end{center}
...
\pagebreak
\begin{center}
Distribuição da escolaridade de autores durante os oito anos
\end{center}
...
\begin{center}
Distribuição da escolaridade entre autores e coautores\bigskip

\resizebox{\textwidth}{!}{
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Titulação} & \textbf{1º autor} & \textbf{2º autor} & \textbf{3º autor} \\ \hline
...
\pagebreak
\begin{center}
Distribuição da formação de autores
\end{center}
...
\begin{tabular}[c]{@{}l@{}}Open source, \emph{software}\\ livre e dados abertos\end{tabular} & 4 & 3,8 \\ \hline
Mídia & 3 & 2,8 \\ \hline
Blogs & 3 & 2,8 \\ \hline
...
Percebe"-se que dos 57 \emph{papers} de ciberpolítica, apenas
...
\tit{castells}, Manuel. (2017), \emph{Redes de indignação e esperança:
...
\tit{lemos}, André. (2002), \emph{Cibercultura: tecnologia e vida social na
...
\tit{lévy}, Pierre. (1999), \emph{Cibercultura}. São Paulo, editora 34.
