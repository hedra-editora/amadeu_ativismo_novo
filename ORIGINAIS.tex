...
Brasil, a atuação \emph{online} dos partidos político tem sido objeto de vários
...
Seeta Peña (Ed.). \emph{online deliberation}: \emph{design, research
...
\tit{gibson}, Rachel K.; \textsc{lusoli}, Wainer; \textsc{ward}, Stephen. (2005) ``online
...
\titidem. (2011) ``Participação política online: questões e
...
um cardápio de candidaturas de lideranças e tal. E teve outras \emph{online},
...
profundidade com 10 participantes ativos/as \emph{offline} na ocupação
...
atuações políticas movimentando feminismos, redes sociais \emph{online} e ruas,
...
mais a distinção entre ativismo \emph{online} e \emph{of"-fline} (Harlow
\& Harp, 2012).
