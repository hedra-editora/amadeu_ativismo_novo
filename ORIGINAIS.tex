...
\emph{bit.ly/2MQCjbO}. Acessado em 18 de
fevereiro de 2014.
...
utilização das mesmas pela sociedade.\footnote{A pesquisa \textsc{tic} Domicílios
  ...
  mensagens (90\%) e o uso de redes sociais (77\%).} %Link:  \emph{www.cetic.br/noticia/acesso-a-Internet-por-banda-larga-volta-a-crescer-nos-domicilios-brasileiros/}}
...
\section{A~Internet~como~\emph{lócus}~da~política}
...
\begin{enumerate}
\item \textbf{Pré"-moderna} (1945--1984)\quad caracterizada pelo \emph{marketing} político
...
Me Representa e coisas do tipo.\footnote{No pleito de 2016 tivemos as
  ...
  candidatura coletiva com nove \emph{codeputados}.} Eu acho que são importantes, pra renovar a
política, pra ter novas figuras''.

  % Ver mais em:
  % \emph{www.cartacapital.com.br/politica/quais-sao-as-novas-formas-de-arejar-a-representacao-politica}
  % Acesso em set. 2019.
...
\item Que lutar por direitos não é crime. Crime é não ter direitos.\footnote{Informações
  disponíveis em \emph{abong.org.br/quem-somos/}.}
\end{itemize}
\end{quote}
...
estruturante para a execução da Rede de Comunicação Cardume\footnote{Mais
  ...
  \emph{abong.org.br/cardume/}. Acesso em 26/09/2019.} permitindo que a \textsc{abong} crie sua própria rede de
...
\emph{hedra.com.br/r/sRv}. Acesso em 19 set. 2021.
...
\emph{occupies} dos Estados Unidos e Espanha. Entre 15 outubro e dezembro
...
social da história \footnote{Disponível em \emph{hedra.com.br/r/MX6}.} e em escala anual o Produto Interno Bruno brasileiro cresceu 6,2\% em relação ao ano de 2010. 
...
%\footnote{Disponível em: \emph{http://saladeimprensa.ibge.gov.br/noticias?view=noticia\&id=1\&busca=1\&idnoticia=1891}}%QUEBRADO
% \footnote{Disponível em: \emph{http://blog.planalto.gov.br/ibge-taxa-de-desemprego-e-a-menor-para-maio-dos-ultimos-nove-anos/}}
%\footnote{Disponível em: \emph{http://exame.abril.com.br/economia/noticias/brasil-cresce-2-7-em-2011-e-se-consolida-como-6a-economia-mundial}}
...
direito à autonomia do corpo''.\footnote{Disponível em \emph{hedra.odoo.com/r/3V3}.}

%\footnote{Página do Movimento Passe Livre de São Paulo: \emph{http://saopaulo.mpl.org.br/}}
...
% \footnote{Atividades do \textsc{mpl} em 2011: \emph{http://saopaulo.mpl.org.br/historico/790-2/}}
...
% \footnote{Plataforma Democracia Real Ya!: \emph{http://www.democraciarealya.es/}} 
...
%   \emph{ocupasampa.milharal.org/nosso-manifesto/}}
...
\end{quote}
%:\emph{http://www.youtube.com/watchv=qMRsV7XWKqU\&feature=context\&context=C3a3057cUDOEgsToPDskJudIVHgGzwumBLufakKpZj} %QUEBRADO   Acessado em 25 de setembro de 2012.}.

A ocupação do Vale do Anhangabaú,\footnote{Ver
  \emph{hedra.com.br/r/ZsZ}.} sob o
...
de comunicação,\footnote{Conferência de Manuel Castells no evento
  internacional \#Arena\textsc{net}mundia. Disponível em \emph{hedra.com.br/r/zQM}.}
...
% \footnote{RiseUp: \emph{help.riseup.net/en}}
...
\emph{Riseup}, como lembra um dos entrevistados:
...
\begin{quote}
O Facebook virou o lugar público e o \emph{Riseup} o lugar privado. Pra gente
combinar coisas importantes era no \emph{Riseup} porque ali não tem como
...
acompanhando \emph{online}, diariamente. (\textit{Indignado}~9)\looseness=-1
\end{quote}
...
%Disponível em:\emph{http://fetase.org.br/mobilizacoes/marcha-das-margaridas/}
...
deputados.\footnote{Disponível em:
  \emph{hedra.com.br/r/UsB}.} Tal projeto, elaborado sem a presença de
...
Mulheres,\footnote{Pelo relatório apresentado em 22 de novembro de 2017
  ...
  em:
  \emph{hedra.com.br/r/DN6}.} onde a Colômbia e o México, até a data desta
...
realizado pelo jornal \emph{online} El País.\footnote{Centera, Mar; Torrado,
  ...
  \emph{hedra.com.br/r/qRh}.} Dois anos depois, a visibilidade do grupo
...
Davis.\footnote{Disponível em \emph{hedra.com.br/r/uuT}.} marcaram o evento discursando sobre aquela
...
que são elas.\footnote{Disponível em \emph{hedra.com.br/r/SVq}.} A autora menciona o movimento político
...
\emph{software} (\textit{bots}) automaticamente gerando reações e re"-tweets nas mídias
sociais \emph{online}. Não obstante a isso, \textit{bots} constroem uma atmosfera de
...
\emph{hedra.com.br/r/k1K}.

\tit{haraway}, Donna (2009). Manifesto Ciborgue. 
%Disponível em: \emph{hedra.com.br/r/K2S}\textgreater{} %QUEBRADO
...
Universit, 2003. 
%\emph{In:} \emph{www.dartmouth.edu/~lhc/docs/achillembembe.pdf} %QUEBRADO
...
``abnormality''.
%Disponível em: \emph{http://www.scielo.br/scielo.php?script=sci\_arttext\&pid=S0104-026X2011000100002}. %QUEBRADO
%Acesso. 20. Jun.2019

\tit{santiago}, Homero (2018) Entrevista: Antonio Negri revisita seu livro ``A
anomalia selvagem: poder e potência em Espinosa''.
\emph{hedra.com.br/r/Wsw}.
...
Opening Governace. \emph{hedra.com.br/r/e9I}. Acesso em 19 set. 2021.
\end{bibliohedra}
...
O chamado ``vazamento de dados do Facebook''\footnote{\textsc{de llano}, Pablo;
  ...
  política mundial. El País, 20 de março de 2018, \emph{online}.}
...
O pedido de patente feito pela Google Inc. em junho de 2017,\footnote{\emph{Automatic suggestions and other content for messaging
...
\begin{enumerate}
\item\, A natureza e o contexto, especialmente o contexto social, da consulta de pesquisa (por exemplo, se a consulta de pesquisa se refere a uma pessoa, um local, um evento, um local, um \emph{software} ou aplicativo da Web, um objeto, etc);
...
vários tipos de automação. (\textsc{gershony} \emph{et al.}, 2017,~ p.\,10)
\end{quote}
...
content for messaging applications}. Disponível em: \textit{hedra.odoo.com/r/1wB}. Acesso em: 21 set. 2018.
...
characteristics from social networking system communications and
characteristics}. Disponível em: \textit{hedra.odoo.com/r/31u}.
Acesso em: 21 set. 2018.

\tit{o'neil}, C. \emph{Weapons of Math Destruction: How \textit{Big Data} Increases
...
% \footnote{\emph{https://www.newschool.edu/parsons/}.
...
% \footnote{\emph{https://tab.uol.com.br/edicao/meme-e-textao\#tematico-1?cmpid=copiaecola}
...
Times.\footnote{Disponível em \emph{hedra.odoo.com/r/2E3}. Acessado em 29/09/2019.}, ``o projeto não anda porque o Facebook está
...
apresenta um \textsc{ted}.\footnote{\emph{bit.ly/2VYgPx2}. Acessado em 28/09/2019.} onde começa falando alguns nomes dos grandes
...
\emph{bit.ly/2mGYruj}, consultado em 06/01/2017.
