...
demonstração'', os impactos da campanha do \emph{Podemos} desde sua
...
dimensões que mensuram \emph{transparência} (tais como indice de
...
legislatura da Câmara dos Deputados do Brasil\footnotemark}
\end{table}
...
Câmara dos Deputados do Brasil\footnotemark}
\end{figure}
...
\caption{Tabela 7: Mandato dos parlamentares por número de tweets,
apresentada por quartis de volume de tweets: 54ª e 55ª legislaturas da
Câmara dos Deputados do Brasil\footnotemark}
\end{figure}
...
acompanhando \emph{online}, diariamente. (Indignado 9)\looseness=-1
\end{quote}
...
%Disponível em: \emph{https://hedra.com.br/r/K2S}\textgreater{} %QUEBRADO
...
Universit, 2003. 
%\emph{In:} \emph{https://www.dartmouth.edu/~lhc/docs/achillembembe.pdf} %QUEBRADO
