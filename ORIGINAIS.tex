...
formatação da opinião em rede}, de Débora Franco Machado, Joyce Souza e Sergio
...
crescente visibilidade dos movimentos negro, feminista e \textsc{lgbtqia}+, entre
...
de ciclistas e de núcleos do movimento \textsc{lgbtqia}+. A iniciativa partiu da
...
participação política.'' In: \textsc{maia}, R., \textsc{gomes}, W. e \textsc{marques},
J. \textit{Internet e Participação Política no Brasil}. Porto Alegre: Editora
Sulina, 2011.
...
comportam; ou mesmo a Marcha da Maconha e a Parada \textsc{lgbtqia}+, são eventos
...
\textit{cannabis}. Neste ano, a marcha \textsc{lgbtqia}+ começa a se tornar uma das
...
\begin{flushright}
\baselineskip=12pt{\textsc{débora franco machado}\\
\textsc{joyce souza}\\
\textsc{sérgio amadeu da silveira}}
\end{flushright}
...
feminista e \textsc{lgbtqia}+, entre outros identificados com o campo da esquerda,
...
grupos \textsc{lgbtqia}+ estariam agora defendendo a pedofilia. Trata"-se de um
pôster com a alegação de que o movimento \textsc{lgbtqia}+ teria adicionado a letra
...
\begin{quote}
O ódio ostensivo aos \textsc{lgbtqia}+ se tornou um eixo central da cada vez mais
...
contra \textsc{lgbtqia}+ --- num país em que a violência conta \textsc{lgbtqia}+ é uma epidemia e
...
da população \textsc{lgbtqia}+ nas redes sociais. Em 2017, o artista foi vítima de um
...
deputado federal, com uma mensagem em tom anti\textsc{lgbtqia}+: ``Os conservadores
...
\tit{ruediger}, Marco Aurélio (coord.). \textit{Robôs, redes sociais e política no Brasil: estudo sobre interferências ilegítimas no debate público na web, riscos à democracia
