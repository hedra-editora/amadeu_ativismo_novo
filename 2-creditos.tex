...
%\textbf{tradução©}\quad			 			{}\\
\textbf{organização©}\quad Rosemary Segurado, Claudio Penteado e\\Sérgio Amadeu da Silveira\\
...
\textbf{preparação}\quad			 		 {Deysi Cioccari}\\
%\textbf{iconografia}\quad			 		 {iconografia}\\
\textbf{projeto gráfico}\quad				 {Ronaldo Alves}\\
%\textbf{imagem da capa}\quad			 	 {imagemcapa}\medskip

\textbf{\textsc{isbn}}\quad			 		 {978-85-7715-616-0}
